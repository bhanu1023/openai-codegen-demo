...
@Service
@AllArgsConstructor
public class PartnerSubscriptionsApiAdapterServiceImpl implements PartnerSubscriptionsApiAdapterService {
        private final PartnerSubscriptionsApiService service;
        @Override
        ...
        ResponseWrapper<PartnerSubscriptionResponse> serviceResponse =
            service.apiToGetPartnerSubscriptionsDetails(data);
