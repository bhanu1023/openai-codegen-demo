...
public interface PartnerSubscriptionsApi {
    ...
    /**
     * POST /partner-subscriptions : Get details for partner subscriptions
     *
     ...
     *         or Partial Content, returned when unable to retrieve information from one of the backend. (status code 206)
     ...
     */
    @Operation(
        operationId = "apiToGetPartnerSubscriptionsDetails",
        summary = "Get details for partner subscriptions",
        tags = { "services" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = PartnerSubscriptionResponse.class))
            }),
            @ApiResponse(responseCode = "206", description = "Partial Content, returned when unable to retrieve information from one of the backend.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = PartnerSubscriptionResponse.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/partner-subscriptions",
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    
    default ResponseEntity<PartnerSubscriptionResponse> apiToGetPartnerSubscriptionsDetails(
        ...
        @Parameter(name = "body", description = "", required = true) @Valid @RequestBody PartnerSubscriptionRequest body,
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"subscriptionDetails\" : [ { \"partnerActivationUrl\" : \"https://\", \"partnerRecoveryUrl\" : \"https://\", \"displayPrice\" : 15.99, \"soc\" : \"NOADNFLX2\", \"provisioningStatus\" : \"ACTIVE\", \"price\" : 11.99, \"socName\" : \"Netflix Standard\" }, { \"partnerActivationUrl\" : \"https://\", \"partnerRecoveryUrl\" : \"https://\", \"displayPrice\" : 15.99, \"soc\" : \"NOADNFLX2\", \"provisioningStatus\" : \"ACTIVE\", \"price\" : 11.99, \"socName\" : \"Netflix Standard\" } ], \"partnerFailures\" : [ { \"userMessage\" : \"Unable to retrieve information from backend System, Please re-try later.\", \"code\" : \"003\", \"partnerName\" : \"APPLE\" }, { \"userMessage\" : \"Unable to retrieve information from backend System, Please re-try later.\", \"code\" : \"003\", \"partnerName\" : \"APPLE\" } ] }";
